...
UfpOptimizer.executeOptimizations = function (settings) {
    ...
    var doStats = function (result) {
        ...
        Logger.info('------------')
        Logger.debug('Results per output file')
        Logger.debug('')
        Logger.debugTable(StatsPrinter.getSummaryDetailsPerFile(optimizerStatResults))
        Logger.debug('------------')
    ...
    console.log('****** UFP OPTIMIZER ' + myPackage.version + ' started ******')
